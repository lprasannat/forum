...
if (isset($_POST["signup"])) {
    if ($_POST["signup"] == "SignUp") {
        ...
        if (!$_POST['FirstNamesignup']) {
            $Error.="please enter firstname <br/>";
        }
         if (!$_POST['LastNamesignup']) {
            $Error.="please enter lastname <br/>";
        }
        /* if (!$_POST['AddressLine1']) {
            $Error.="please enter addressline1 <br/>";
        }
         if (!$_POST['AddressLine2']) {
            $Error.="please enter addressline2 <br/>";
        }
         if (!$_POST['City']) {
        ...
        if ($Error)
            $Error .= "there were errors in your signup details<br/>";
        else {
